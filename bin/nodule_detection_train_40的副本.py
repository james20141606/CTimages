...
def main():
    ...
    posi_train = posiname[:4000]
    nega_train = neganame[:4000]
    ...
    posi_val = posiname[4000:]
    nega_val = neganame[4000:]
    ...
    batch_size = 20      #set to a proper number according to the memory
